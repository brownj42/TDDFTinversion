...
module minresqlpDataModule
  ...
  integer,  parameter, public :: dp      = 8! selected_real_kind(15,307)    ! 64-bit real, default
  integer,  parameter, public :: sp      = 4! selected_real_kind(6,37)      ! 32-bit real
 !integer,  parameter, public :: qp      = selected_real_kind(33,4931)   !128-bit real

  integer,  parameter, public :: ip      = 4!selected_int_kind(9)          ! R: (-10^R, 10^R)
  ...
  real(dp), allocatable :: TW(:,:),ryw(:,:),iyw(:,:),dyw(:),mW(:)
  integer :: npartw
